    ...
    <div style="page-break-inside: avoid; ${t>0?"margin-top: 36px; padding-top: 24px; border-top: 2px dashed #e0e0e0;":""}">
      ...
      <div class="inv-meta">
        ...
        <div class="inv-meta-cell">
          ...
          <div class="inv-meta-value" style="font-size: 11px;">${s(e.paymentMethod||"N/A")}</div>
        </div>
      </div>
